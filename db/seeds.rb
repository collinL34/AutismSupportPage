...
art3 = Article.create(category_id: 2, link: 'https://www.autismspeaks.org/node/314251', author_id: 1)
art4 = Article.create(category_id: 5, link: 'https://www.autismspeaks.org/advocacy/advocacy-news/autism-speaks-legislative-wins-2016', author_id: 1)
art5 = Article.create(category_id: 2, link: 'https://www.autismspeaks.org/science/resources-programs/autism-treatment-network', author_id: 1)
art6 = Article.create(category_id: 2, link: 'https://iancommunity.org/', author_id: 1)
art7 = Article.create(category_id: 6, link: 'https://takesbrains.org/', author_id: 1)
